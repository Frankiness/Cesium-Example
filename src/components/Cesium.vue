<template>
  <div class="slider">
    ...
    <a-col :span="50">
      <a-slider v-model:value="scaleVal" :min="1" :max="20" />
    </a-col>
  </div>
...
const update3dtilesMaxtrix = () => {
  ...
  Cesium.Matrix4.multiply(m, scale, m); //旋转矩阵相乘
  //旋转、平移矩阵相乘
...
const initEarth = async () => {
  ...
  tileset = new Cesium.Cesium3DTileset({
    url: "http://data.mars3d.cn/3dtiles/max-shihua/tileset.json", //此处填写tileset url地址
